...
# 9, not 8 -- 8 ("View log") became a real menu option once the Settings
# TUI gained it; this must stay genuinely out of range for the assertion
# below to mean what it says.
OUT_OF_RANGE_TUI="$(_cfg_tui $'9\nq\n')"

it "keeps an empty menu choice in the same prompt instead of a dead end"
assert_contains "$INVALID_TUI" "Please choose 1-8 or q."
...
assert_contains "$OUT_OF_RANGE_TUI" "Please choose 1-8 or q."
...
[[ $CFG_ARROW_PROMPT -eq 1 && $CFG_ARROW_WRITE -eq 1 && $CFG_ARROW_RC -eq 0 ]] \
    && assert_contains "$CFG_ARROW_OUT" "Please choose 1-8 or q." \
...
# main-menu choice and prints a spurious "Please choose 1-8 or q." -- harmless,
